...
label_R = LabelFr("R", frm, 0, 0, font, 5)
label_L = LabelFr("L", frm, 0, 1, font, 1)
label_Uc = LabelFr("Uc", frm, 0, 2, font, 0)
label_alpha = LabelFr("alpha", frm, 0, 3, font, 0.002)
label_T = LabelFr("T", frm, 0, 4, font, 250)
label_k = LabelFr("k", frm, 0, 5, font, 0.065)
label_c = LabelFr("c", frm, 0, 6, font, 1.84)
label_t_min = LabelFr("Tmin", frm, 0, 7, font, 0.001)
label_e = LabelFr("e", frm, 0, 8, font, 0.000001)
label_K = LabelFr("K", frm, 0, 9, font, 120)
label_I = LabelFr("I", frm, 0, 10, font, 40)
...
scheme = ('Явная схема', 'Неявная схема', 'Схема Кранка-Николсона', 'Явная(Рунге)', 'Явная+Рунге', 'ЯРА')
